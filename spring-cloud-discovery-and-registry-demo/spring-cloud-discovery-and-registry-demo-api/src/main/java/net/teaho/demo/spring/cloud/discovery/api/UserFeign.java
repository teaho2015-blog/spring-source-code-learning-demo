package net.teaho.demo.spring.cloud.discovery.api;
...
@FeignClient(value = "spring-cloud-discovery-and-registry-demo-service", fallback = UserFeignFallback.class)
public interface UserFeign {
    ...
    @GetMapping(value = "/user/detail", produces = "application/json;charset=utf-8")
